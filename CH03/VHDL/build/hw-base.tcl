...
if { $list_projs eq "" } {
   create_project -force hw hw -part xczu3eg-sfvc784-2-e
}
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
    ...
    CONFIG.PSU_DDR_RAM_HIGHADDR $highaddr \
...
\
    ...
    CONFIG.PSU__DDRC__BG_ADDR_COUNT $bg_addr_count \
    ...
    CONFIG.PSU__DDRC__DRAM_WIDTH $dram_width \
...
\
    ...
    CONFIG.PSU__PROTECTION__SLAVES $ddr_high \

...
# ---------------------------------------------------------------------------
# ch12_add_ps <pl0_mhz> ?<pl1_mhz>? ?<pl2_mhz>? ?<need_irq1>?
#
...
proc ch12_check_ps_ports {} {
    ...
    if {$bad} {
        error "PS-PL master port width does not match the booting image.\
               ...
               output. See the note above ch12_boot_port_widths."
    }
    puts " PS-PL master port widths match the booting image"
}

proc ch12_add_ps {pl0_mhz {pl1_mhz 0} {pl2_mhz 0} {need_irq1 0} {hp_ports {0 1}}} {
...
# ---------------------------------------------------------------------------
# ch12_finish <proj_dir> <proj_name> <bd_name> <out_dir> <basename> <jobs>
#
#   Wrapper, implementation, and the two files PYNQ actually needs.
# ---------------------------------------------------------------------------
proc ch12_finish {proj_dir proj_name bd_name out_dir basename jobs} {

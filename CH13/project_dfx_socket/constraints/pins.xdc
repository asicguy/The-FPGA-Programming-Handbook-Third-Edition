# CH13 DFX socket -- camera pin constraints
#
# Unchanged from CH12 project 3: the static region IS CH12 project 3's camera
# pipeline, and the camera's pins are physical, which is exactly why the camera
# cannot move into the reconfigurable partition.
#

// rm_sobel.sv
// ------------------------------------
// Reconfigurable module: CH12's filter unchanged: gray / Sobel / invert / colour by mode
// ------------------------------------
// Author : Frank Bruno
//
...
// What this one computes is in rm_sobel_core.sv.
//
...
module rm_sobel
  ...
  localparam [31:0] KERNEL_ID = 32'hA5A50001;

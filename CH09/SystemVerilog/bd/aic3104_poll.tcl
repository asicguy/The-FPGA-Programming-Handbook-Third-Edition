...
proc create_hier_cell_audio { parentCell nameHier } {
  ...
  # Create instance: aic3104_poll_wrapper_0, and set properties
  set block_name aic3104_poll_wrapper
  set block_cell_name aic3104_poll_wrapper_0
  if { [catch {set aic3104_poll_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $aic3104_poll_wrapper_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins s_axi1] [get_bd_intf_pins aic3104_poll_wrapper_0/s_axi]
  ...
  connect_bd_net -net aic3104_poll_wrapper_0_AIC_lrclk_o  [get_bd_pins aic3104_poll_wrapper_0/AIC_lrclk_o] \
  [get_bd_pins AIC_lrclk_o]
  connect_bd_net -net aic3104_poll_wrapper_0_AIC_sclk_o  [get_bd_pins aic3104_poll_wrapper_0/AIC_sclk_o] \
  [get_bd_pins AIC_sclk_o]
  connect_bd_net -net aic3104_poll_wrapper_0_i2s_sdata_o  [get_bd_pins aic3104_poll_wrapper_0/i2s_sdata_o] \
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net aic3104_poll_wrapper_0_i2s_sdata_o  [get_bd_pins audio/i2s_sdata_o] \
  ...
  assign_bd_address -offset 0x80000000 -range 0x00400000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs audio/aic3104_poll_wrapper_0/s_axi/reg0] -force

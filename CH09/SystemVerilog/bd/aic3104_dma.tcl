...
proc create_hier_cell_audio { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 0 -to 0 gpio_io_o_0
  create_bd_pin -dir O -type intr iic2intc_irpt
  create_bd_pin -dir O -type clk clk_out1_0
  create_bd_pin -dir I i2s_sdata_i_0
  create_bd_pin -dir O AIC_lrclk_o_0
  create_bd_pin -dir O AIC_sclk_o_0
  create_bd_pin -dir O i2s_sdata_o_0
  ...
  set_property -dict [list \
    CONFIG.CLKOUT1_JITTER {333.949} \
    CONFIG.CLKOUT1_PHASE_ERROR {400.629} \
    CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {12.288} \
    CONFIG.MMCM_CLKFBOUT_MULT_F {80.875} \
    CONFIG.MMCM_CLKOUT0_DIVIDE_F {89.750} \
  ...
  # Create instance: aic3104_dma_wrapper_0, and set properties
  set block_name aic3104_dma_wrapper
  set block_cell_name aic3104_dma_wrapper_0
  if { [catch {set aic3104_dma_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $aic3104_dma_wrapper_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins aic3104_dma_wrapper_0/m_axi] [get_bd_intf_pins m_axi]
  ...
  connect_bd_intf_net -intf_net s_axi2_1 [get_bd_intf_pins s_axi2] [get_bd_intf_pins aic3104_dma_wrapper_0/s_axi]

  # Create port connections
  connect_bd_net -net aic3104_dma_wrapper_0_AIC_lrclk_o  [get_bd_pins aic3104_dma_wrapper_0/AIC_lrclk_o] \
  [get_bd_pins AIC_lrclk_o_0]
  connect_bd_net -net aic3104_dma_wrapper_0_AIC_sclk_o  [get_bd_pins aic3104_dma_wrapper_0/AIC_sclk_o] \
  [get_bd_pins AIC_sclk_o_0]
  connect_bd_net -net aic3104_dma_wrapper_0_i2s_sdata_o  [get_bd_pins aic3104_dma_wrapper_0/i2s_sdata_o] \
  ...
  [get_bd_pins aic3104_dma_wrapper_0/AIC_mclk_o]
  connect_bd_net -net i2s_sdata_i_0_1  [get_bd_pins i2s_sdata_i_0] \
  [get_bd_pins aic3104_dma_wrapper_0/i2s_sdata_i]
...
\
  ...
  # Create instance: rst_ps8_0_95M, and set properties
  set rst_ps8_0_95M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps8_0_95M ]
  ...
  connect_bd_intf_net -intf_net audio_m_axi [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP0_FPD] [get_bd_intf_pins audio/m_axi]
  ...
  # Create port connections
  connect_bd_net -net audio_AIC_lrclk_o_0  [get_bd_pins audio/AIC_lrclk_o_0] \
  [get_bd_ports AIC_lrclk_o]
  connect_bd_net -net audio_AIC_sclk_o_0  [get_bd_pins audio/AIC_sclk_o_0] \
  [get_bd_ports AIC_sclk_o]
  connect_bd_net -net audio_clk_out1_0  [get_bd_pins audio/clk_out1_0] \
  [get_bd_ports AIC_mclk_o]
  connect_bd_net -net audio_gpio_io_o_0  [get_bd_pins audio/gpio_io_o_0] \
  [get_bd_ports AIC_nRST]
  connect_bd_net -net audio_i2s_sdata_o_0  [get_bd_pins audio/i2s_sdata_o_0] \
  ...
  assign_bd_address -offset 0xA0400000 -range 0x00400000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs audio/aic3104_dma_wrapper_0/s_axi/reg0] -force
  ...
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces audio/aic3104_dma_wrapper_0/m_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces audio/aic3104_dma_wrapper_0/m_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces audio/aic3104_dma_wrapper_0/m_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force

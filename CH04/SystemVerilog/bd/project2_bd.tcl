...
################################################################
# This is a generated script based on design: project2_bd
#
...
\
  ...
  # Create instance: project_2_wrapper_0, and set properties
  set block_name project_2_wrapper
  set block_cell_name project_2_wrapper_0
  if { [catch {set project_2_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $project_2_wrapper_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property CONFIG.SELECTOR {CASE} $project_2_wrapper_0


  # Create port connections
  connect_bd_net -net PL_USER_PB_0_1  [get_bd_ports PL_USER_PB] \
  [get_bd_pins project_2_wrapper_0/PL_USER_PB]
  connect_bd_net -net PL_USER_SW_0_1  [get_bd_ports PL_USER_SW] \
  [get_bd_pins project_2_wrapper_0/PL_USER_SW]
  connect_bd_net -net project_2_wrapper_0_PL_USER_LED  [get_bd_pins project_2_wrapper_0/PL_USER_LED] \
  [get_bd_ports PL_USER_LED]
